...
(function () {
  ...
  LW.KEYS = { config: 'lw.config', records: 'lw.records', stockLog: 'lw.stockLog', overlayConfig: 'lw.overlayConfig', skipAnim: 'lw.skipAnim', prizeList: 'lw.prizeList', meta: 'lw.meta', excelHandle: 'excelHandle' };
